...
public class BoardRestController {
	...
	public List<Board> getByListName(String listName, Principal principal, int page) {
		// return bs.getBoardByListName(listName,"ParkHyeokJoon");
		return bs.getBoardByListName(listName, "ParkHyeokJoon", page);
	}
	...
	public void writeBoard(Board board, Principal principal, MultipartFile[] image) throws Exception {
		// board.setWriter(mr.findById("ParkHyeokJoon").get());
		board.setWriter(mr.findById("ParkHyeokJoon").get());
		bs.saveBoard(board);
		bs.setBoardImage(board, image);
		as.savementionAlarms(board, "ParkHyeokJoon");
	}
